# -*- encoding: utf-8 -*-
# stub: rails_admin 2.0.0.beta ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<coffee-rails>.freeze, ["< 6", ">= 4.0"])
      ...
      s.add_dependency(%q<rails>.freeze, ["< 7", ">= 5.0"])
      s.add_dependency(%q<remotipart>.freeze, ["~> 1.3"])
      s.add_dependency(%q<sass-rails>.freeze, ["< 7", ">= 4.0"])
